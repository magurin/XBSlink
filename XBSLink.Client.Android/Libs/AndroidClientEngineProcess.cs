...
namespace XBSLink.Client.Android
{
    public class AndroidClientEngineProcess 
    {
        ...
        {
            SendMessage(xlink_client_messages_clouds_helper.ClientCloudCreateJoin(Cloud, MaxUsers, Password));
        }
        ...
        public void ClientCloudJoin( string Cloud)
        {
          ...
          {
              SendMessage(xlink_client_messages_clouds_helper.ClientConnect());
          }

          public void ClientDisconnect()
          {
              SendMessage(xlink_client_messages_clouds_helper.ClientDisconnect());
          }

          public void ClientDiscover()
          {
              SendMessage(xlink_client_messages_clouds_helper.ClientDiscover());
          }

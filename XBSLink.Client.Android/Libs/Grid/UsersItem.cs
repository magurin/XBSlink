...
namespace XBSLink.Client.Android.Libs.Grid
{
    ...
    public class UsersItem
        {
            ...
            public UsersItem(XBSLink.General.xlink_server_user_online_message message) :this(message._username,message._client_version, message._last_ping_delay_ms,false)
            {
            ...
            public void SetData(XBSLink.General.xlink_server_user_online_message user)
            {
